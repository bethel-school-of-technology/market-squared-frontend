...
function transferProjectToRemote(failed, successful) {
  return ssh.putDirectory(
    '../market-squared-frontend',
    '/home/ubuntu/market-squared-frontend-temp',
    {
      recursive: true,
      concurrency: 1,
...
function createRemoteTempFolder() {
  return ssh.execCommand(
    'rm -rf market-squared-frontend-temp && mkdir market-squared-frontend-temp', {
      cwd: '/home/ubuntu'
  });
}
...
function updateRemoteApp() {
  return ssh.execCommand(
    'mkdir market-squared-frontend && cp -r market-squared-frontend-temp/* market-squared-frontend/ && rm -rf market-squared-frontend-temp', {
      cwd: '/home/ubuntu'
  });
}
...
function restartRemoteServices() {
  return ssh.execCommand(
    'cd market-squared-frontend && sudo service mongod start && pm2 start app.js', {
      cwd: '/home/ubuntu'
  });
}
...
function sshConnect() {
  ...
  ssh
    ...
    .then(function() {
      console.log('Creating `market-squared-frontend-temp` folder.');
